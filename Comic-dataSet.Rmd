...
allcomicscorrelation$name<-as.character(allcomicscorrelation$name)
allcomicscorrelation$name_length<-nchar(allcomicscorrelation$name)
...
cor(allcomicscorrelation[,-which(names(allcomicscorrelation) == "name")])
