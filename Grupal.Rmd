...
Para la variable APPEARANCES, es necesaria la creación de un modelo de regresión lineal que calcule las apariciones de los datos faltantes. Esta será creada luego de la fase de ETL, en la que se normalizaran los datos que serán insumos para ese modelo.
...
#################################################################
dccorrelation<-dc[,-15:-20]

#estos atributos son nulos en análisis ya que vienen representados por URL.LENGTH Y NAME.LENGTH
...
- NAME.LENGTH(cantidad de carácteres que posee el nombre de un personaje) posee cierta correlación inversa con page_id y EYE. Hay que destacar la gran correlación que existe entre NAME.LENGTH y URL.LENGTH.

- URL.LENGTH (cantidad de carácteres que posee la url de la página del personaje) posee cierta correlación inversa con page_id y EYE, al igual que ocurre en NAME.LENGTH.
...
marvelcorrelation<-marvel[,-15:-20]
...
allcomicscorrelation<-allcomics[,-15:-20]
...
- NAME.LENGTH(cantidad de carácteres que posee el nombre de un personaje) posee cierta correlación inversa con EYE. Hay que destacar la gran correlación que existe entre NAME.LENGTH y URL.LENGTH.

- URL.LENGTH (cantidad de carácteres que posee la url de la página del personaje) posee cierta correlación inversa con page_id, EYE y HAIR.
...
#ELIMINACIÓN DE VARIABLES REDUNDANTES Y DE AQUELLAS QUE NO TIENEN RELEVANCIA EN LA PREDICCION DE LAS APARICIONES
